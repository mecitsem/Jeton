...
namespace Jeton.Api.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRepository<App>, RepositoryBase<App>>();
            container.RegisterType<IRepository<Token>, RepositoryBase<Token>>();
            container.RegisterType<IRepository<User>, RepositoryBase<User>>();
